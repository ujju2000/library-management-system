...
export const AppLayout = () => {
    ...
    const { user, loginUser, logoutUser, isAdmin, registerUser } = useUser();
    ...
    return (
        <>
            <AppBar className = {classes.background} position="static" sx ={{ backgroundColor : '#164863'}}>
                <Container maxWidth="xl">
                    <Toolbar disableGutters>
                        <LocalLibraryIcon sx={{ display: "flex", mr: 1 }} />
